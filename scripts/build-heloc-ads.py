...
<meta property="og:url" content="%(url)s"/><meta property="og:image" content="https://stonehavencre.com/assets/stonehaven-handpainted-logo.png"/>
...
<link rel="stylesheet" href="../styles.css?v=polish-20260918"/><link rel="stylesheet" href="../funnel.css?v=cleanup2-20260918"/>
...
<div class="est-range" id="e-range">-</div><div class="est-verdict" id="e-verdict"></div><p class="est-note" id="e-note">Headroom at common 80 to 90 percent combined loan-to-value caps. A specialist confirms the real number by text.</p></div>
</div></div></section>'''
    if t == 'table':
        c = m['cols']
...
(function(){
  ...
  function est(){
    ...
    else{$("e-range").textContent=moneyK(lo.available)+" \\u2013 "+moneyK(hi.available);$("e-verdict").textContent="potentially accessible";$("e-note").textContent="Headroom at common 80 to 90 percent combined loan-to-value caps. A specialist confirms the real number by text.";}
    if(arguments.length&&$("f-value")&&!$("f-value").dataset.touched)$("f-value").value=v;
    if(arguments.length&&$("f-balance")&&!$("f-balance").dataset.touched)$("f-balance").value=b;
